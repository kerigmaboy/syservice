...
echo "<table>";
 ...
 echo"<tr bgcolor=#f8fdbb>";
            echo"<th colspan='4'>";
            echo"<font size='5' color='BLACK'> TODOS LOS CASOS ASOCIADOS  </font>";
            echo"</th>";
          echo"</tr>";
echo "</table>";
...
while($row3 = $result3->fetch_assoc()) {
  ...
  echo"<td>";
  $sqlESTATUS = "SELECT estatus,MAX(fecha) AS fecha FROM  jos_actualizacion where id_os =".$row3[id_caso];
  $resultESTATUS = $conn->query($sqlESTATUS);
  $rowESTATUS = $resultESTATUS->fetch_assoc();
  echo"<font size='3' color='BLUE'>"."ESTATUS: "."</font>"."<font size='3' color='BLACK'>".$rowESTATUS[estatus]."</font>";
  echo"</td>";
  echo"</tr>";
...
echo"<tr>";
 echo"<td>";
    echo"<font size='3' color='blue'>"."FECHA : "."</font>"."<font size='3' color='BLACK'>".$row[fecha_agendamiento]."</font>";
 echo"</td>";
 ...
 echo"<td>";
    echo"<font size='3' color='blue'>"."TELEFONO: "."</font>"."<font size='3' color='BLACK'>".$row[tlf1]."</font>";
 echo"</td>";
...
///query orden_servicio
  ...
  echo"<input type=hidden name='responsable' value=$user >";
   echo"<input type='submit' value='VER DETALLE DEL CASO' >";
  echo"</form >";
